export const translations = {
  ...
  en: {
    ...
    clients: {
      ...
      primaryLocationDescription: 'Set as the main service location for this client',
    ...
    notifications: {
      ...
      offRequestNotifications: 'Field Request Notifications',
      offRequestNotificationsDesc: 'Notifications about field requests',
      offRequests: 'New field requests from employees',
      offRequestStatus: 'Field request approvals/rejections',
    ...
    financial: {
      ...
      entries: 'entries',
      entry: 'entry',
      noEntries: 'No financial entries found for the selected filters.',
      currency: 'Currency: CAD (Canadian Dollar)',
      invoice: 'Invoice',
      payment: 'Payment',
      visit: 'Visit',
      payroll: 'Payroll',
  ...
  fr: {
    ...
    clients: {
      ...
      province: 'Province',
      postalCode: 'Code postal',
      petDetails: 'Détails animaux',
      primaryLocation: 'Emplacement principal',
      primaryLocationDescription: 'Définir comme emplacement de service principal pour ce client',
      locationCreated: 'Emplacement ajouté avec succès',
      locationUpdated: 'Emplacement mis à jour avec succès',
      locationDeleted: 'Emplacement supprimé avec succès',
      noLocations: 'Aucun emplacement ajouté',
    ...
    notifications: {
      ...
      sendTo: 'Envoyer à',
      groupBroadcast: 'Groupe (Diffusion)',
      ...
      offRequestNotifications: 'Notifications de demandes de terrain',
      offRequestNotificationsDesc: 'Notifications sur les demandes de terrain',
      offRequests: 'Nouvelles demandes de terrain des employés',
      offRequestStatus: 'Approbations/rejets de demandes de terrain',
    ...
    financial: {
      ...
      description: 'Vue complète de toutes les transactions et événements financiers',
      grossRevenue: 'Revenus Bruts',
      received: 'Reçu',
      outstanding: 'En Attente',
      payrollCost: 'Coût de Paie',
      ...
      entries: 'entrées',
      entry: 'entrée',
      noEntries: 'Aucune entrée financière trouvée pour les filtres sélectionnés.',
      currency: 'Devise: CAD (Dollar Canadien)',
      invoice: 'Facture',
      payment: 'Paiement',
      visit: 'Visite',
      payroll: 'Paie',
      ...
      approved: 'Approuvé',
      cash: 'Comptant',
      eTransfer: 'Virement Électronique',
      cheque: 'Chèque',
