...
export default function ForgotPassword() {
  ...
  // Dark-only styles
  const cardClass = 'bg-transparent border border-white/[0.03] shadow-2xl';
    ...
    <AuthLayout>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          {/* Success Message */}
          {successMsg && (
            <div className="mb-5 rounded-xl px-4 py-2.5 text-sm font-medium bg-green-500/10 border border-green-500/20 text-green-400">
              {successMsg}
            </div>
          )}
